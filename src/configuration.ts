...
export namespace Configuration {
  ...
  export function fromEnvironment(
    ...
    config.version = envVariables.VERSION;

    if (envVariables.BEARER_ACCESS_TOKEN) {
      config.bearerCredentials = {
        accessToken: envVariables.BEARER_ACCESS_TOKEN,
      };
    }

    if (envVariables.BASIC_USERNAME && envVariables.BASIC_PASSWORD) {
      config.basicCredentials = {
        username: envVariables.BASIC_USERNAME,
        password: envVariables.BASIC_PASSWORD,
      };
    }
