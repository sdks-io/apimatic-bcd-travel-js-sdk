...
| `dropOffLocation` | [`DropOffLocation`](../../doc/models/drop-off-location.md) | Required | - |
| `endDateTime` | `string` | Required | - |
| `fare` | [`Fare \| undefined`](../../doc/models/fare.md) | Optional | - |
...
| `pickupLocation` | [`DropOffLocation`](../../doc/models/drop-off-location.md) | Required | - |
