...
| `payments` | [`Payment2[]`](../../doc/models/payment-2.md) | Required | - |
| `taxes` | [`Taxis3[]`](../../doc/models/taxis-3.md) | Required | - |
| `products` | [`Products1`](../../doc/models/products-1.md) | Required | - |
...
```json
{
  ...
  "globalCustomerNumber": "globalCustomerNumber2",
  "accountId": "accountId4",
  "customerNumber": "customerNumber6",
  "isInternational": false,
  "recordLocator": "recordLocator8",
  "lastModifiedDateTime": "lastModifiedDateTime8",
  "version": 0,
  "approvals": [
    "approvals1",
    "approvals2"
