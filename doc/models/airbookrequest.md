...
| `creditCardIdentifier` | `string` | Required | - |
| `billingAddress` | [`BillingAddress`](../../doc/models/billing-address.md) | Required | - |
...
```json
{
  ...
  "booker_email": "agent@bcdtriptech.com",
  ...
  "credit_card_first_name": "Jonathan",
