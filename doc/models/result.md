...
| `subtotal` | `number \| undefined` | Optional | - |
...
| `products` | [`Products`](../../doc/models/products.md) | Required | - |
...
```json
{
  ...
  "globalCustomerNumber": "globalCustomerNumber8",
  "accountId": "accountId0",
  "customerNumber": "customerNumber2",
  "isInternational": false,
  "recordLocator": "recordLocator4",
  "lastModifiedDateTime": "lastModifiedDateTime4",
  "version": 56,
  "approvals": [
    "approvals7",
    "approvals8",
